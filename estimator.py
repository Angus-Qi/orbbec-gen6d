...
class Gen6DEstimator:
    ...
    def build(self, database: BaseDatabase, split_type: str):
        ...
        self.selector.load_ref_imgs(ref_imgs_rots, ref_poses, object_center, object_vert) #ref_imgs_rots is list of ref_imgs + rotated imgs
    ...
    def predict(self, que_img, que_K, pose_init=None):
        ...
        if pose_init is None:
            ...
            with torch.no_grad():
                ...
                position = detection_outputs['positions'][0] #centre of boundingbox
                scale_r2q = detection_outputs['scales'][0] #ratio between detected boundingbox size and ref img size
            ...
            pose_pr = estimate_pose_from_similarity_transform_compose(
                position, scale_r2q, angle_r2q, ref_pose, ref_K, que_K, self.ref_info['center']) #object centre here is 3d coordinate, in colmap values
        else:
            pose_pr = pose_init
