...
def select_reference_img_ids_refinement(ref_database, object_center, ref_ids, sel_pose, refine_ref_num=6, refine_even_ref_views=False, refine_even_num=128):
    ...
    if refine_even_ref_views: #this only for training phase, farthest point sampling is fairly efficient apparently
        # use fps to resample the reference images to make them distribute more evenly fps=farthest point sampling
    ...
    ref_idxs = ref_idxs[:refine_ref_num] # Choose the 6 most correlated frames
